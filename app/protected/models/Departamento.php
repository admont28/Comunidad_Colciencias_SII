...
class Departamento extends CActiveRecord{
	...
	public function rules(){
		...
		return array(
			array('nombreDepartamento, Pais_idPais', 'required'),
			array('Pais_idPais', 'numerical', 'integerOnly'=>true),
			array('nombreDepartamento', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idDepartamento, nombreDepartamento, Pais_idPais', 'safe', 'on'=>'search'),
		);
	}
