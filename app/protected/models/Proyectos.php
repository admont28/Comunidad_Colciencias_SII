...
class Proyectos extends CActiveRecord{
	...
	public function rules(){
		...
		return array(
			array('participacionInst, nombreProyecto, institucion', 'match','pattern' => '/^[a-zA-Z\sñÑóÓáÁéÉíÍúÚ]*$/','message'=>'El campo sólo puede ser texto.'),
	...
	/**
	 * Fundion que verifica una llave primaria duplicada.
